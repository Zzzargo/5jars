package com.zargo.fivejars.spring_server.features.authentication.services;

import com.zargo.fivejars.spring_server.features.authentication.exceptions.InvalidCredentialsException;
import com.zargo.fivejars.spring_server.features.authentication.exceptions.UsernameTakenException;
import com.zargo.fivejars.spring_server.features.authentication.dtos.AuthResponse;
import com.zargo.fivejars.spring_server.features.authentication.dtos.LoginRequest;
import com.zargo.fivejars.spring_server.features.authentication.dtos.RegisterRequest;
import com.zargo.fivejars.spring_server.features.users.dtos.UserResponse;
import com.zargo.fivejars.spring_server.features.users.repository.UserRepository;
